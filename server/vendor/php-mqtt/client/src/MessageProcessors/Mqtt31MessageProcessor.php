...
class Mqtt31MessageProcessor extends BaseMessageProcessor implements MessageProcessor
{
    ...
    public function buildConnectMessage(ConnectionSettings $connectionSettings, bool $useCleanSession = false): string
    {
        ...
        $header = Mqtt31MessageProcessor . phpchr(0x10);
    ...
    public function buildPingRequestMessage(): string
    {
        ...
        return Mqtt31MessageProcessor . phpchr(0xc0);
    }
    ...
    public function buildPingResponseMessage(): string
    {
        ...
        return Mqtt31MessageProcessor . phpchr(0xd0);
    }
    ...
    public function buildDisconnectMessage(): string
    {
        ...
        return Mqtt31MessageProcessor . phpchr(0xe0);
    }
    ...
    public function buildSubscribeMessage(int $messageId, array $subscriptions, bool $isDuplicate = false): string
    {
        ...
        $header = Mqtt31MessageProcessor . phpchr(0x82);
    ...
    public function buildUnsubscribeMessage(int $messageId, array $topics, bool $isDuplicate = false): string
    {
        ...
        $header  = Mqtt31MessageProcessor . phpchr($command);
    ...
    {
        return Mqtt31MessageProcessor . phpchr(0x40) . $this->encodeMessageId($messageId);
    }
    ...
    {
        return Mqtt31MessageProcessor . phpchr(0x50) . $this->encodeMessageId($messageId);
    }
    ...
    {
        return Mqtt31MessageProcessor . phpchr(0x62) . $this->encodeMessageId($messageId);
    }
    ...
    {
        return Mqtt31MessageProcessor . phpchr(0x70) . $this->encodeMessageId($messageId);
    }
