...
class Mqtt31MessageProcessorTest extends TestCase
{
    ...
    public function buildConnectMessage_testDataProvider(): array
    {
        return [
            // Default parameters
            [new ConnectionSettings(), false, Mqtt31MessageProcessorTest . phphex2bin('101900064d51497364700300000a000b')],

            // Clean Session
            [new ConnectionSettings(), true, Mqtt31MessageProcessorTest . phphex2bin('101900064d51497364700302000a000b')],
            ...
            [
                (new ConnectionSettings())
                    ...
                    ->setPassword('bar'),
                true,
                Mqtt31MessageProcessorTest . phphex2bin('102300064d514973647003c2000a000b') . hex2bin('0003') . 'foo' . hex2bin('0003') . 'bar',
            ],
            ...
            [
                ...
                true,
                Mqtt31MessageProcessorTest . phphex2bin('102800064d5149736470030e000a000b') . hex2bin('0008') . 'test/foo' . hex2bin('0003') . 'bar',
            ],
            ...
            [
                (new ConnectionSettings())
                    ...
                    ->setPassword('blubber'),
                true,
                Mqtt31MessageProcessorTest . phphex2bin('103700064d514973647003f6000a000b') . hex2bin('0008') . 'test/foo' . hex2bin('0003') . 'bar'
    ...
    public function buildSubscribeMessage_testDataProvider(): array
    {
        ...
        return [
            ...
            [62304, [new Subscription($longTopic, 1)], '82' . '8701' . hex2bin('01')],
        ];
    }
