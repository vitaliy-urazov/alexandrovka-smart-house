...
class Mqtt311MessageProcessorTest extends TestCase
{
    ...
    public function buildConnectMessage_testDataProvider(): array
    {
        return [
            // Default parameters
            [new ConnectionSettings(), false, Mqtt311MessageProcessorTest . phphex2bin('101700044d5154540400000a000b')],

            // Clean Session
            [new ConnectionSettings(), true, Mqtt311MessageProcessorTest . phphex2bin('101700044d5154540402000a000b')],
            ...
            [
                (new ConnectionSettings())
                    ...
                    ->setPassword('bar'),
                true,
                Mqtt311MessageProcessorTest . phphex2bin('102100044d51545404c2000a000b') . hex2bin('0003') . 'foo' . hex2bin('0003') . 'bar',
            ],
            ...
            [
                ...
                true,
                Mqtt311MessageProcessorTest . phphex2bin('102600044d515454040e000a000b') . hex2bin('0008') . 'test/foo' . hex2bin('0003') . 'bar',
            ],
            ...
            [
                (new ConnectionSettings())
                    ...
                    ->setPassword('blubber'),
                true,
                Mqtt311MessageProcessorTest . phphex2bin('103500044d51545404f6000a000b') . hex2bin('0008') . 'test/foo' . hex2bin('0003') . 'bar'
